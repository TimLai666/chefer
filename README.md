...
single executable ── user double-clicks ──> chefer-runtime
  ...
  └─ pick platform backend:
       ...
       Windows → WSL2 (auto-provisioned minimal distro; WHP fallback preflights host readiness but reports unavailable until implemented)
